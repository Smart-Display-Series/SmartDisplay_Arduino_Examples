...
ConfigCmd configCmdArray[] = {
  ...
  {.index = Idx01_id, .subIndex = obj_posX,     .count = 2, .dataType = int16,  .data = 80          },  // set obj x
  {.index = Idx01_id, .subIndex = obj_posY,     .count = 2, .dataType = int16,  .data = 30          },  // set obj y
  ...
  {.index = Idx02_id, .subIndex = obj_type, .count = 1, .dataType = uint8, .data = 0  },  // set obj type empty
  {.index = Idx03_id, .subIndex = obj_type, .count = 1, .dataType = uint8, .data = 0  },  // set obj type empty
